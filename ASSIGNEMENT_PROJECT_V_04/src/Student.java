...
public class Student  extends  Shelf {//Student class starts

    private String studentNumber, studentFaculty;

    public Student(String[] categoryName, int shelfNumber, int count, String studentNumber, String studentFaculty) {
